    ...
    return (
        <>
            <div className="pb-16 pt-5 text-center lg:pt-8 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 dark:text-slate-50 sm:text-7xl hyphens-manual">
                    <div className="relative text-blue-600">
                        ...
                        <div className="relative hyphens-manual">Datenschutz&shy;erklärung</div>
                    </div>{' '}
                </h1>
