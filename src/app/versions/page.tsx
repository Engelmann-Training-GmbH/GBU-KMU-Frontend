import VersionFeed from "@/app/versions/_components/VersionFeed";
                ...
                <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 dark:text-slate-50 sm:text-7xl">
                    <span className="relative whitespace-nowrap text-blue-600">
                        <svg
                            aria-hidden="true"
                            viewBox="0 0 418 42"
                            className="absolute left-0 top-1/2 h-[0.58em] w-full fill-blue-300/70 dark:fill-blue-900/70"
                        ...
                        <span className="relative">Versionsverlauf</span>
                    </span>{' '}
                </h1>
                <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700 dark:text-slate-300 block">
                    Hier finden Sie die Übersicht über alle aktuellen und veralteten Versionen der GBU-KMU.
                </p>
            </div>
            <VersionFeed/>
        </>
