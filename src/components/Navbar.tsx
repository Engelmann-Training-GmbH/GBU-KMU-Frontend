...
import gbu from "@/app/images/gbu_kmu.svg";
import gbu_dark from "@/app/images/gbu_kmu_dark.svg";
import Image from "next/image";

const navigation = [
    {name: 'Home', href: '/', current: true},
    {name: 'Versionen', href: '/versions', current: false},
]
...
export default function Navbar() {
    return (
        <Disclosure as="nav" className="bg-gray-300/50 dark:bg-gray-800/50">
                                ...
                                {navigation.map((item) => (
                                    <a
                                        ...
                                        className={classNames(
                                            item.current ? 'bg-gray-400/70 dark:bg-gray-800/70 text-black dark:text-white' : 'hover:bg-gray-400/70 hover:dark:bg-gray-800/70 text-black dark:text-white',
